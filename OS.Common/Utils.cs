...
namespace  OS.Common {
	public class Utils {
		...
		/// </summary>
		/// <returns></returns>
		public static string GetUserNumber(string n) {
			string num = DateTime.Now.Year.ToString("");//yyyyMMddHHmmssms\
			if (num.Length == 4) {
				num = num.Substring(2, 2);
			}
			string type = "1";
			switch (n) {
				case "1": type = "2"; break;
			...
			return num + type + "0" + Number(4).ToString();
		}
		#endregion
		...
		public static string OutPageList(int pageSize, int pageIndex, int totalCount, string linkUrl, int centSize) {
			...
			string firstBtn = "<li><span><a class=\"footchange\" href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex - 1).ToString()) + "\">上一页</a></span></li>";
			string lastBtn = "<li><span><a class=\"footchange\" href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex + 1).ToString()) + "\">下一页</a></span></li>";
			...
			if (pageIndex <= 1) {
				firstBtn = "<li><span><a class=\"footchange\">上一页</a></span></li>";
			}
			if (pageIndex >= pageCount) {
				lastBtn = "<li><span><a class=\"footchange\">下一页</a></span></li>";
			}
			if (pageIndex == 1) {
				firstStr = "<li><a class=\"footchange\">1</a></li>";
			}
			if (pageIndex == pageCount) {
				lastStr = "<li><a class=\"footchange\">" + pageCount.ToString() + "</a></li>";
			}
			...
			if (lastNum >= pageCount)
				lastNum = pageCount - 1;
			//pageStr.Append("<a>共" + totalCount + "记录</a>");
			...
			for (int i = firstNum; i <= lastNum; i++) {
				if (i == pageIndex) {
					pageStr.Append("<li><a class=\"footchange\">" + i + "</a></li>");
				} else {
