<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adv_view.aspx.cs" Inherits="OS.Web.manage.advert.adv_view" %>
...
<div class="tab-content">
  ...
  <dl>
    <dt>复制代码</dt>
    <dd>
      <textarea id="txtCopyUrl" class="input" style="vertical-align:middle;"><script type="text/javascript" src="/ashx/advert_js.ashx?id=<%=model.id%>"></script></textarea>
