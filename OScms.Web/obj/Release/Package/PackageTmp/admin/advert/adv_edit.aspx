<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adv_edit.aspx.cs" Inherits="OS.Web.manage.advert.adv_edit" ValidateRequest="false" %>
    ...
    <dd>
      <div class="rule-multi-radio">
          <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
            ...
            <asp:ListItem Value="7">自定义</asp:ListItem>
           </asp:RadioButtonList>
       </div>
    </dd>
  </dl>
