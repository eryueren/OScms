        ...
        <div class="tab-content">
            ...
            <dl <%=this.category_id==128||this.category_id==96||this.category_id==122||this.category_id==129||this.category_id==130?"style='display:none'":"" %>>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">首页=新闻将显示到首页</span>
                </dd>
            </dl>
            <dl <%=this.category_id==128?"style='display:none'":"" %>>
                <dt>排序数字</dt>
            ...
            <dl id="div_sub_title" style='display: none'>
                <dt>
            ...
            <dl id="div_source" style='display: none'>
                <dt>
            ...
            <dl id="div_author" style='display: none'>
                <dt>
