<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_edit.aspx.cs" Inherits="OS.Web.admin.users.user_edit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
            ...
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li><a href="javascript:;" onclick="tabs(this);">附属信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    <div class="rule-single-select">
                        <asp:DropDownList ID="ddlGroupId" runat="server" datatype="*" errormsg="请选择组别" sucmsg=" " onc></asp:DropDownList>
                    </div>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>用户名</dt>
                <dd>
                    <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" " ajaxurl="../../ashx/admin_ajax.ashx?action=validate_username"></asp:TextBox>
            ...
            <dl>
                <dt>邮箱账号</dt>
                <dd>
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="input normal" datatype="*0-50" sucmsg=" "></asp:TextBox>
            ...
            <dl <%=this.groupId =="3"?"":"style='display:none'" %>>
                <dt>学校</dt>
                <dd>
                    <asp:TextBox ID="txtUniversities" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl <%=this.groupId  =="3"?"":"style='display:none'" %>>
                <dt>专业</dt>
                <dd>
                    <asp:TextBox ID="txtProfessional" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl <%=this.groupId =="1"?"":"style='display:none'" %>>
                <dt>活跃音频领域</dt>
                <dd>
                    <asp:TextBox ID="txtGoodat" runat="server" CssClass="input normal"></asp:TextBox>
                     <span class="Validform_checktip">多个用英文逗号（,）隔开 </span>
                </dd>
            </dl>
            <dl <%=this.groupId =="1"?"":"style='display:none'" %>>
                <dt>从事工作</dt>
                <dd>
                    <asp:TextBox ID="txtWorkat" runat="server" CssClass="input normal"></asp:TextBox>
                    <span class="Validform_checktip">多个用英文逗号（,）隔开   例：广播电视工程师,音乐家</span>
                </dd>
            </dl>
            <dl <%=this.groupId =="2"?"":"style='display:none'" %>>
                <dt>机构所在行业</dt>
                <dd>
                    <asp:TextBox ID="txtIndustry" runat="server" CssClass="input normal"></asp:TextBox>
                     <span class="Validform_checktip">多个用英文逗号（,）隔开</span>
                </dd>
            </dl>
        </div>
        ...
        <div class="tab-content" style="display: none;">
            <dl style="display: none">
                <dt>账户金额</dt>
                <dd>
                    <asp:TextBox ID="txtPoint" runat="server" CssClass="input small" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox>
                    元
