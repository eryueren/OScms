<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_list.aspx.cs" Inherits="OS.Web.admin.users.user_list" %>
        ...
        function PostSMS(mobiles) {
            ...
            var dialog = $.dialog({
                ...
                ok: function () {
                    ...
                    $.ajax({
                        type: "post",
                        url: "../../ashx/admin_ajax.ashx?action=sms_message_post",
                        data: postData,
                        dataType: "json",
