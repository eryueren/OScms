<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_attach.aspx.cs" Inherits="OS.Web.admin.dialog.dialog_attach" %>
...
<script type="text/javascript">
    ...
    //页面加载完成执行
    $(function () {
        $(".upload-attach").InitSWFUpload({ filesize: "20480", sendurl: "../../ashx/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;*.rar;*.zip;*.doc;*.xls" });
    ...
    function execAttachHtml() {
        if ($("input[name='attachType']:checked").val() == 0) {
            ...
            $.ajax({
                type: "post",
                url: "../../ashx/admin_ajax.ashx?action=get_remote_fileinfo",
                data: {
                    remotepath: function () {
