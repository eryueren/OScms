<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="OS.Web.admin.users.user_audit" %>
...
<body class="mainbody">
            ...
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li>
                            <asp:LinkButton ID="btnAudit" runat="server" CssClass="save" OnClientClick="return ExePostBack('btnAudit','审核通过后会员正常使用，是否继续？');" OnClick="btnAudit_Click"><i></i><span>审核通过</span></asp:LinkButton></li>
                    </ul>
                </div>
                <div class="r-list">
    ...
    <th width="8%">积分</th>--%>
          ...
          <a class="msg" href="message_list.aspx?keywords=<%#Eval("user_name")%>" title="消息记录">短消息</a>
                    ...
                    <td><%#new OS.BLL.users.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
                    <td><%#Eval("email")%></td>
