<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="OS.Web.admin.settings.sys_config" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
            ...
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li><a href="javascript:;" onclick="tabs(this);">会费设置</a></li>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>网站咨询QQ</dt>
                <dd>
                    <asp:TextBox ID="webcountcode" runat="server" CssClass="input" />
            ...
            <dl>
                <dt>微信</dt>
                <dd>
                    <asp:TextBox ID="webweiXin" runat="server" CssClass="input normal upload-path" />
                    <div class="upload-box upload-img"></div>
                </dd>
            </dl>
            <dl>
                <dt>微博</dt>
                <dd>
                    <asp:TextBox ID="webweibo" runat="server" CssClass="input normal upload-path" />
                    <div class="upload-box upload-img"></div>
                </dd>
            </dl>
            <dl>
                <dt>通讯地址</dt>
                <dd>
                    <asp:TextBox ID="webaddress" runat="server" CssClass="input" TextMode="MultiLine" />
                </dd>
            </dl>
            <dl>
                <dt>联系电话</dt>
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="Validform_checktip">*网站后台登陆时进行验证！</span>
                </dd>
            </dl>
...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">尚未申请？<a href="http://sms.YL.net" target="_blank">请点击这里注册</a></span>
    </dd>
  </dl>
  <dl>
    <dt>平台登录账户</dt>
  ...
  <dl>
    ...
    <dd>
      ...
      如果您尚未申请开通，<a href="http://sms.YL.net" target="_blank">请点击这里注册</a>成功后填写您的用户名和密码均可正常使用。
    </dd>
  </dl>
</div>--%>
<!--/手机短信设置-->
        ...
        <div class="tab-content" style="display: none">
            <dl>
                <dt>个人会费</dt>
                <dd>
                    <asp:TextBox ID="pricepeople" runat="server" CssClass="input normal" datatype="*0-7" sucmsg=" " />
                    <span class="Validform_checktip">*金额</span>
                </dd>
            </dl>
            <dl>
                <dt>机构会费</dt>
                <dd>
                    <asp:TextBox ID="pricemechanism" runat="server" CssClass="input normal" datatype="*0-7" sucmsg=" " />
                    <span class="Validform_checktip">*金额</span>
                </dd>
            </dl>
            ...
            <dl>
                <dt>学生会费</dt>
                <dd>
                    <asp:TextBox ID="pricestudent" runat="server" CssClass="input normal" datatype="*0-7" sucmsg=" " />
                    <span class="Validform_checktip">*金额</span>
                </dd>
            </dl>
        ...
        <!--/邮件发送设置-->
          <div class="tab-content" style="display: none">aaa</div>
        <!--上传配置-->
        <div class="tab-content" style="display: none">
            <dl>
                <dt>文件上传目录</dt>
