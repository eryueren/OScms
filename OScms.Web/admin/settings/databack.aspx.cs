...
namespace OS.Web.manage.settings
{
    public partial class databack : OS.Web.UI.ManagePage
    {
        Model.configs.siteconfig config = new BLL.configs.siteconfig().loadConfig(); //获得站点配置信息
