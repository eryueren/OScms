<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="OS.Web.admin.article.article_list" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function progressBar() {
            var dialog = $.dialog({
                title: '发布',
                content: 'url:../dialog/dialog_progressBar.aspx?category_id=<%=this.category_id %>',
                min: false,
                max: false,
                lock: true,
                width: 500,
            ...
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        ...
                        <li style="display: none"><a class="list" href="javascript:progressBar();"><i></i><span>发布</span></a></li>
                    </ul>
                    <div class="menu-list">
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        <th width="6%">选择</th>
                        <th align="left"><%=this.category_id==128?"活动时间":"标题" %></th>
                        <th align="left" width="16%"><%=this.category_id==128?"活动时间":"发布时间" %></th>
                        <th align="left" width="12%">所属类别</th>
                        <th align="left" width="65" <%=this.category_id==128?"style='display:none'":"" %>>排序</th>
                        <th align="left" width="110" <%=this.category_id==128||this.category_id==96||this.category_id==122?"style='display:none'":"" %>>属性</th>
                        <th width="8%">操作</th>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
                    ...
                    <td <%=this.category_id==128?"style='display:none'":"" %>>
                        <div class="btn-tools">
