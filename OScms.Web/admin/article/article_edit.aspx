<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_edit.aspx.cs" Inherits="OS.Web.admin.article.article_edit" ValidateRequest="false" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".upload-album").each(function () {
                $(this).InitSWFUpload({ btntext: "批量上传", btnwidth: 66, single: false, water: true, thumbnail: true, filesize: "2048", sendurl: "../../ashx/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;" });
            });
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="article_list.aspx?category_id=<%=this.category_id %>" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <%= page_menu(this.category_id)%>
            <i class="arrow"></i>
            <span>编辑信息</span>
        </div>
            ...
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li><a href="javascript:;" onclick="tabs(this);" <%=this.category_id==128||this.category_id==96||this.category_id==129||this.category_id==122||this.category_id==130?"style='display:none'":"" %>>详细描述</a></li>
        ...
        <div class="tab-content">
            <dl>
                <dt>所属类别</dt>
                <dd>
                    <%= column_menu(this.category_id)%>
                </dd>
            </dl>
            <dl <%=this.category_id==128?"style='display:none'":"" %>>
                <dt>显示状态</dt>
                <dd>
            ...
            <dl <%=this.category_id==128||this.category_id==96||this.category_id==122||this.category_id==129||this.category_id==130?"style='display:none'":"" %>>
                <dt>推荐类型</dt>
                <dd>
            ...
            <dl>
                <dt><%=this.category_id==128?"活动标题":"内容标题" %></dt>
                <dd>
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" " />
                    <span class="Validform_checktip">*标题最多100个字符</span>
                </dd>
            </dl>
            <dl id="div_sub_title" <%=this.category_id==96||this.category_id==122||this.category_id==129||this.category_id==130?"style='display:none'":"" %>>
                <dt>
                    <asp:Label ID="div_sub_title_title" runat="server" Text="副标题1" /></dt>
                <dd>
                    ...
                    <asp:TextBox ID="txtSeoDescription" runat="server" CssClass="input" Width="300px" datatype="*0-100" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">100个字符以内</span>
                </dd>
            </dl>
            <dl id="div_source"  <%=this.category_id==123||this.category_id==124||this.category_id==125||this.category_id==126||this.category_id==127?"":"style='display:none'" %>>
                <dt>
                    <asp:Label ID="div_source_title" runat="server" Text="副标题2" /></dt>
                <dd>
                    <asp:TextBox ID="txtSeoTitle" runat="server" CssClass="input" Width="300px" datatype="*0-100" sucmsg=" " ></asp:TextBox>
                    <asp:Label ID="div_source_tip" runat="server" CssClass="Validform_checktip" />
                </dd>
            </dl>
            <dl id="div_author" <%=this.category_id ==123||this.category_id==124||this.category_id==125||this.category_id==126||this.category_id==127?"":"style='display:none'" %>>
                <dt>
                    <asp:Label ID="div_author_title" runat="server" Text="副标题3" /></dt>
                <dd>
                    <asp:TextBox ID="txtSeoKeywords" runat="server" CssClass="input" Width="300px" datatype="*0-100" sucmsg=" "></asp:TextBox>
                    <asp:Label ID="div_author_tip" runat="server" CssClass="Validform_checktip" />
                </dd>
            </dl>
            <dl  <%=this.category_id==130?"style='display:none'":"" %>>
                <dt>封面图片</dt>
                <dd>
      ...
      <asp:Label ID="div_sell_price_tip" runat="server" CssClass="Validform_checktip" />
            ...
            <dl>
                <dt><%=this.category_id==128?"活动开始时间":"发布时间" %></dt>
                <dd>
