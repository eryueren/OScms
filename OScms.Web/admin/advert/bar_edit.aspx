<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bar_edit.aspx.cs" Inherits="OS.Web.manage.advert.bar_edit" ValidateRequest="false" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".upload-img").each(function () {
            $(this).InitSWFUpload({ sendurl: "/ashx/upload_ajax.ashx", flashurl: "../../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;*.flv;" });
        });
    });
</script>
</head>
