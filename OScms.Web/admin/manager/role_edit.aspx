<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_edit.aspx.cs" Inherits="OS.Web.admin.manager.role_edit" ValidateRequest="false" %>
        ...
        <tbody>
          ...
          <tr>
            <td style="white-space:nowrap;word-break:break-all;overflow:hidden;">
              <asp:HiddenField ID="hidName" Value='<%#Eval("call_index") %>' runat="server" />
