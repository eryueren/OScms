...
namespace OS.Model.configs {
	...
	public class siteconfig {
		...
		private string _sysdatabaseprefix = "cra_";
		private string _sysencryptstring = "OS";

		private string _webweixin = "";
		private string _webweibo = "";

		private decimal _pricepeople;
		private decimal _pricemechanism;
		private decimal _pricestudent;
		...
		/// 会费 个人
		/// </summary>
		public decimal pricepeople {
			get { return _pricepeople; }
			set { _pricepeople = value; }
		}
		/// <summary>
		/// 会费 机构
		/// </summary>
		public decimal pricemechanism {
			get { return _pricemechanism; }
			set { _pricemechanism = value; }
		}
		/// <summary>
		/// 会费 学生
		/// </summary>
		public decimal pricestudent {
			get { return _pricestudent; }
		...
		/// 微信
		/// </summary>
		public string webweixin {
			get { return _webweixin; }
			set { _webweixin = value; }
		} /// <summary>
		/// 微博
		/// </summary>
		public string webweibo {
			get { return _webweibo; }
			set { _webweibo = value; }
		}
		#endregion
