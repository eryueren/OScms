...
namespace  OS.DAL.contents
{
    ...
    public partial class article_attribute_field
    {
        ...
        /// 获得频道对应的数据
        /// </summary>
        public DataSet GetList(int category_id, string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + databaseprefix + "article_attribute_field.* ");
            strSql.Append(" FROM " + databaseprefix + "article_attribute_field INNER JOIN " + databaseprefix + "category_field ON " + databaseprefix + "article_attribute_field.id = " + databaseprefix + "category_field.field_id");
