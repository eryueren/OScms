...
namespace  OS.DAL.users
{
    ...
    public partial class user_message
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.users.user_message model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.users.user_message model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public Model.users.user_message GetModel(int id)
        {
            ...
            OS.Model.users.user_message model = new OS.Model.users.user_message();
