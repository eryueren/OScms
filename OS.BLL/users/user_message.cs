...
namespace OS.BLL.users
{
    ...
    public partial class user_message
    {
        ...
        private readonly DAL.users.user_message dal;
        public user_message()
        {
            dal = new DAL.users.user_message(siteConfig.sysdatabaseprefix);
        }
        ...
        {
            Model.users.user_message model = new Model.users.user_message();
            model.type = type;
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(OS.Model.users.user_message model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(OS.Model.users.user_message model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.users.user_message GetModel(int id)
        {
