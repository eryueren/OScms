...
namespace OS.BLL.users
{
    ...
    public partial class user_point_log
    {
        ...
        private readonly DAL.users.user_point_log dal;
        public user_point_log()
        {
            dal = new DAL.users.user_point_log(siteConfig.sysdatabaseprefix);
        }
        #region  Method
        /// <summary>
        /// 是否存在该记录
        ...
        {
            Model.users.user_point_log model = new Model.users.user_point_log();
            ...
            {
                new BLL.users.users().Upgrade(user_id);
            }
            return result;
        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.users.user_point_log GetModel(int id)
        {
