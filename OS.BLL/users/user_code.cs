...
namespace OS.BLL.users
{
    ...
    public partial class user_code
    {
        ...
        private readonly DAL.users.user_code dal;
        public user_code()
        {
            dal = new DAL.users.user_code(siteConfig.sysdatabaseprefix);
        }
        #region  Method
        /// <summary>
        /// 是否存在该记录
        ...
        /// 根据生成码得到一个对象实体
        /// </summary>
        public Model.users.user_code GetModel(string str_code)
        {
        ...
        /// <returns></returns>
        public Model.users.user_code GetModel(string user_name, string code_type, string datepart)
        {
