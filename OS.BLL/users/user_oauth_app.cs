...
namespace OS.BLL.users
{
    ...
    public partial class user_oauth_app
    {
        ...
        private readonly DAL.users.user_oauth_app dal;
        public user_oauth_app()
        {
            dal = new DAL.users.user_oauth_app(siteConfig.sysdatabaseprefix);
        }
        ...
        /// 根据接口目录返回一个实体
        /// </summary>
        public Model.users.user_oauth_app GetModel(string api_path)
        {
