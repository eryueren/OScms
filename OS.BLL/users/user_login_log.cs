...
namespace OS.BLL.users
{
    ...
    public partial class user_login_log
    {
        ...
        private readonly DAL.users.user_login_log dal;
        public user_login_log()
        {
            dal = new DAL.users.user_login_log(siteConfig.sysdatabaseprefix);
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.users.user_login_log model)
        {
            return dal.Add(model);
        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.users.user_login_log GetModel(int id)
        {
        ...
        /// 根据用户名取得最后登录的MODEL
        /// </summary>
        public Model.users.user_login_log GetLastModel(string user_name)
        {
