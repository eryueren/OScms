...
namespace OS.BLL.users
{
    ...
    public partial class user_amount_log
    {
        ...
        private readonly DAL.users.user_amount_log dal;
        public user_amount_log()
        {
            dal = new DAL.users.user_amount_log(siteConfig.sysdatabaseprefix);
        }
        #region  Method
        /// <summary>
        /// 是否存在该记录
        ...
        {
            Model.users.user_amount_log model = new Model.users.user_amount_log();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.users.user_amount_log model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.users.user_amount_log GetModel(int id)
        {
        ...
        /// 根据订单号返回一个实体
        /// </summary>
        public Model.users.user_amount_log GetModel(string order_no)
        {
