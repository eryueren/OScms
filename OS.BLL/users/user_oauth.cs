...
namespace OS.BLL.users
{
    ...
    public partial class user_oauth
    {
        ...
        private readonly DAL.users.user_oauth dal;
        public user_oauth()
        {
            dal = new DAL.users.user_oauth(siteConfig.sysdatabaseprefix);
        }
        ...
        /// 根据开放平台和openid返回一个实体
        /// </summary>
        public Model.users.user_oauth GetModel(string oauth_name, string oauth_openid)
        {
