...
namespace OS.BLL.contents
{
    ...
    public partial class article_attribute_field
    {
        ...
        private readonly DAL.contents.article_attribute_field dal;

        public article_attribute_field()
        {
            dal = new DAL.contents.article_attribute_field(siteConfig.sysdatabaseprefix);
        }
        #region  Method
        /// <summary>
        /// 是否存在该记录
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.contents.article_attribute_field> GetModelList(int category_id, string strWhere)
        {
            DataSet ds = dal.GetList(category_id, strWhere);
