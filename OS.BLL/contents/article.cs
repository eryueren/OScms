...
namespace OS.BLL.contents
{
    ...
    public partial class article
    {
        ...
        private readonly DAL.contents.article dal;

        public article()
        {
            dal = new DAL.contents.article(siteConfig.sysdatabaseprefix);
        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.contents.article GetModel(string call_index)
        {
        ...
        {
			return dal.GetListByTags(Top, strWhere, filedOrder);
        }
