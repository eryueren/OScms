...
namespace OS.BLL.managers
{
    ...
    public partial class manager
    {
        ...
        private readonly DAL.managers.manager dal;
        public manager()
        {
            dal = new DAL.managers.manager(siteConfig.sysdatabaseprefix);
        }
        ...
        /// 根据用户名密码返回一个实体
        /// </summary>
        public Model.managers.manager GetModel(string user_name, string password)
        {
        ...
        /// 根据用户名密码返回一个实体
        /// </summary>
        public Model.managers.manager GetModel(string user_name, string password, bool is_encrypt)
        {
            //检查一下是否需要加密
            if (is_encrypt)
            {
