...
namespace OS.BLL.managers
{
    ...
    public partial class manager_log
    {
        ...
        private readonly DAL.managers.manager_log dal;
        public manager_log()
        {
            dal = new DAL.managers.manager_log(siteConfig.sysdatabaseprefix);
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.managers.manager_log model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.managers.manager_log GetModel(int id)
        {
        ...
        /// 根据用户名返回上一次登录记录
        /// </summary>
        public Model.managers.manager_log GetModel(string user_name, int top_num, string action_type)
        {
